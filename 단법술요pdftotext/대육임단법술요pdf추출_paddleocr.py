...
def ocr_pdf_to_text(pdf_path):
    ...
    try:
        ...
        # PaddleOCR 모델 초기화 (중국어 간체)
        ocr_model = PaddleOCR(lang='ch', use_angle_cls=True, show_log=False)
...
def process_pdf_and_save_chapters(pdf_file, output_dir, chapter_titles):
    print(f"Processing PDF with PaddleOCR: {pdf_file}")
