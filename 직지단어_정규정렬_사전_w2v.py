...
print(f"Mecab 기존 사전에 저장된 단어 수: {len(mecab_existing_dict)}")
print(f"Okt 사용자 사전에 저장된 단어 수: {len(okt_user_dict)}")
print(f"Okt 기존 사전에 저장된 단어 수: {len(okt_existing_dict)}")
print(f"Komoran 사용자 사전에 저장된 단어 수: {len(komoran_user_dict)}")
print(f"Komoran 기존 사전에 저장된 단어 수: {len(komoran_existing_dict)}")
...
print("사용자 사전과 기존 사전이 dict 디렉토리에 저장되었습니다.")
