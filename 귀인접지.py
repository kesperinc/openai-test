...
noble_list = ['貴', '匕', '朱', '合', '勾', '靑', '空', '白', '常', '玄', '陰', '后']
...
def create_6x6_tianpan_and_tianjiang(month_zang_sequence, divination_hour, day_gan):
    ...
    """"""
    create_tianjuang_sequence(start_index, month_zang_sequence)
...
def create_4x4_tianjiang(day_gan, divination_hour, tianjiang_sequence, month_zang_sequence):
    ...
    # 천장의 시작 인덱스 찾기
    start_noble_index = find_noble_start_index(day_gan, divination_hour, month_zang_sequence)

    create_tianjuang_sequence(start_noble_index, month_zang_sequence)
    ...
    # 천장을 결합하여 4x4 배열에 배치
    for i in range(12):
        pos_index = (start_index - i if reverse_order else start_index + i) % 12
        x, y = diban_coords[month_zang_sequence[pos_index]]
